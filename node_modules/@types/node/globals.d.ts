...
declare global {
    ...
    namespace NodeJS {
        ...
        // FIRST CHANGE: Added 'any' option here down below to the Dict <T> object,
        // REASON WHY: the connection with the Azure database in the backend/db.config./db.js file was not
        // working, giving me this error: " Server requires encryption, set 'encrypt' config option to true"
        // SOLUTION: Gave an 'any' type option to this config, so that the 
        //  "  encrypt: process.env.DB_ENCRYPT = true " option could hve a boolean datatype.
        // ** SECOND CHANGE: REPLACED 'any' with 'boolean'.
        interface Dict<T> {
            [key: string]: T | undefined | boolean;
        }
